	  ...
	  <div class="container">
		...
		<div class="navbar-header">
		 <!-- <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
		  ...
		  <a class="navbar-brand" href="">Sistem Pendukung Keputusan Pemilihan Program Studi di Universitas</a>
		</div>
		...
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4 col-md-4">
		  	...
		  	<div style="margin-top: 100px;" class="panel panel-default"><div class="panel-body">
				...
				<button type="button" onclick="location.href='user-baru2.php'" class="btn btn-secondary btn-lg btn-block">Register</button>
		  	</div></div>
