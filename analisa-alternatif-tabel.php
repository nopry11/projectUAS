...
<div class="row">
	...
	<ol class="breadcrumb">
	  ...
	  <li><a href="analisa-alternatif.php"><span class="fa fa-balance-scale"></span> Analisis Alternatif</a></li>
	  <li class="active"><span class="fa fa-table"></span> Tabel Analisis Alternatif</li>
	</ol>
<form method="post">
	<div class="row">
...
?>
    ...
    <button type="button" onclick="location.href='analisa-alternatif.php'" class="btn btn-primary"><span class="fa fa-clone"></span> Analisis Jurusan Selanjutnya</button>
    
            <button type="submit" onclick="location.href='rangking.php'" name="hapus-contengan" class="btn btn-success"><span class="fa fa-bar-chart"></span> Selesai, Lanjut Ke Perangkingan</button>
    </div>
</div>
</div>			
<?php
