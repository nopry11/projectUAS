...
//			include_once 'sidebar.php';
	...
	<ol class="breadcrumb">
	  ...
	  <li><a href="analisa-kriteria.php"><span class="fa fa-bomb"></span> Analisis Kriteria</a></li>
	  <li class="active"><span class="fa fa-table"></span> Tabel Analisis Kriteria</li>
	</ol>
<form method="post">
	<div class="row">
