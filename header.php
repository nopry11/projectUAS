        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="main.php">Sistem Pendukung Keputusan Pemilihan Program Studi Di Universitas</a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           <!-- <li role="presentation"><a href="nilai.php"><span class="fa fa-modx"></span> Data Nilai</a></li>-->
                            ...
                            <li role="presentation"><a href="data-alternatif.php"><span class="fa fa-book"></span> Data Alternatif Program Studi</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li role="presentation"><a href="analisa-alternatif.php"><span class="fa fa-balance-scale"></span> Analisis Alternatif Program Studi</a></li>
